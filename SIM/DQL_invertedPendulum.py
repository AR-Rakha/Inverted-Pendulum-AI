...
env =InvertedPendulum(0,0,math.pi,mc,mp,L,g,bp,fps)
env.setTimeLimit(15)  # 10 seconds
env.setForce(force)
...
def plot_durations(show_result=False):
  ...
  if len(rewards_t) >= 100:
        ...
        plt.plot(reward_means.numpy(), label="Reward")
...
torch.save(policy_net.state_dict(), "dqn_pendulum.pth")
